...
def newOdon(msg):
	...
	print("posicionrobot 0  es ",msg.points[0])
...
msg3 = ModelState();
msg4 = ModelState();
msg1.model_name="coche_1_1"
msg2.model_name="coche_2_2"
msg3.model_name="coche_3_3"
msg4.model_name="coche_4_4"
#msg.pose.position.x = 0.0
#msg.pose.position.y = 0.0
#msg.pose.orientation.z = 12.5
#msg.pose.orientation.w = 25.0

msg1_ant = Point();
msg1_ant.x = msg1.pose.position.x
msg1_ant.y = msg1.pose.position.y
...
#	inc_x = goal.x - msg.pose.position.x
#	inc_y = goal.y - msg.pose.position.y
#
#	angle_to_goal = atan2(inc_y, inc_x)
#	print("theta 0  es ",theta)
#
...
#	(msg.pose.position.x - msg_ant.x)/(msg.pose.position.y - msg_ant.y)



#	if msg.pose.position.x < 3.0:
	msg1.pose.position=msg.points[0]
	msg2.pose.position=msg.points[1]
	msg3.pose.position=msg.points[2]
	msg4.pose.position=msg.points[3]
#	else:
